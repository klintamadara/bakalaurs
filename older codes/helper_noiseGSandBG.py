...
TXT_DIR_PSM3 = 'texts_processed/noiseGS+BG/' # directory storing OCR result using PSM 3
...
result_file_psm3 = open(TXT_DIR_RSLTS + results + "_noiseGSandBG.txt", 'w')
print("Levenshtein; Jaccard; Overlap", file = result_file_psm3)


result_file_psm3.close()

result_file_psm3 = open(TXT_DIR_RSLTS + results + "_noiseGSandBG.txt", 'a')
