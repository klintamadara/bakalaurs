...
IMG_DIR = 'images_processed/BGremove/' # directory with the images w/out background
IMG_DIR_AFTER = 'images_processed/B&W+BGremove/' #directory storing pre-processed images
TXT_DIR = 'texts_processed/B&W+BGremove/' # directory storing OCR result from the pre-processed images
