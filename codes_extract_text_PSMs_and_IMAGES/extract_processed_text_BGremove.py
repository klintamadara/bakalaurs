...
IMG_DIR_AFTER = 'images_processed/BGremove/' #directory storing pre-processed images
TXT_DIR = 'texts_processed/BGremove/' # directory storing OCR result from the pre-processed images
