...
TXT_DIR = 'texts_raw/psm3/' # directory storing OCR result from the original images
...
for t in product_type:
    for x in range(1, 101):
        ...
        #OCR configuration:
        #--psm -> page segmentation mode. 3 - "Fully automatic page segmentation, but no OSD. (Default)"
